...
FileProgress.prototype.setComplete = function(up, info) {
  ...
  var showImg = $('<img src="/static/plugins/qiniu/images/loading.gif"/>');

  progressNameTd.append(Wrapper);

  if (!isImg) {
    showImg.attr('src', '/static/plugins/qiniu/images/default.png');
    ...
    $(img).on('load', function() {
      ...
      function initImg(url, key, height) {
        ...
        modalBody.find('img').attr('src', '/static/plugins/qiniu/images/loading.gif');
